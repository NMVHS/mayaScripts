...
def main():
    ...
    offsetAutoNegBtn = cm.button(label = "<<-|", width = 50, command = lambda x: offsetKey("auto",-2))
    offsetAutoNegBtn = cm.button(label = "<-|", width = 50, command = lambda x: offsetKey("auto",-1))
    ...
    offsetAutoPosBtn = cm.button(label = "|->", width = 50, command = lambda x: offsetKey("auto",1))
    offsetAutoPosBtn = cm.button(label = "|->>", width = 50, command = lambda x: offsetKey("auto",2))
